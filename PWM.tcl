...
#
# PWM.tcl: Tcl script for re-creating project 'PWM'
#
# Generated by Vivado on Sun Sep 28 10:10:55 +0300 2025
...
#
# 1. This project restoration tcl script (PWM.tcl) that was generated.
#
...
#
#    "D:/Vivado_projects/Third_sem/Lab1/rtl/PWM.v"
#    "D:/Vivado_projects/Third_sem/Lab1/rtl/PWM_TB.v"
#    "D:/Vivado_projects/Third_sem/Lab1/xdc/PWM.xdc"
#
#*****************************************************************************************
...
set files [list \
 [file normalize "${origin_dir}/rtl/PWM.v"] \
 [file normalize "${origin_dir}/rtl/PWM_TB.v"] \
]
...
set obj [get_filesets sources_1]
set_property -name "top" -value "PWM" -objects $obj
...
set file "[file normalize "$origin_dir/xdc/PWM.xdc"]"
set file_added [add_files -norecurse -fileset $obj [list $file]]
set file "$origin_dir/xdc/PWM.xdc"
...
set obj [get_filesets constrs_1]
set_property -name "target_constrs_file" -value "[file normalize "$origin_dir/xdc/PWM.xdc"]" -objects $obj
set_property -name "target_ucf" -value "[file normalize "$origin_dir/xdc/PWM.xdc"]" -objects $obj
...
if {[string equal [get_runs -quiet synth_1] ""]} {
    create_run -name synth_1 -part xc7a35ticsg324-1L -flow {Vivado Synthesis 2018} -strategy "Vivado Synthesis Defaults" -report_strategy {No Reports} -constrset constrs_1
} else {
...
if {[string equal [get_runs -quiet impl_1] ""]} {
    create_run -name impl_1 -part xc7a35ticsg324-1L -flow {Vivado Implementation 2018} -strategy "Vivado Implementation Defaults" -report_strategy {No Reports} -constrset constrs_1 -parent_run synth_1
} else {
